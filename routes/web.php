...
Route::post('/admin/gestiones', [App\Http\Controllers\GestionController::class, 'store'])->name('admin.gestiones.store')->middleware('auth');
...
Route::post('/admin/carreras', [App\Http\Controllers\CarreraController::class, 'store'])->name('admin.carreras.store')->middleware('auth');
...
Route::post('/admin/niveles', [App\Http\Controllers\NivelController::class, 'store'])->name('admin.niveles.store')->middleware('auth');
Route::get('/admin/niveles/{id}', [App\Http\Controllers\NivelController::class, 'show'])->name('admin.niveles.show')->middleware('auth');
