            ...
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/admin/gestiones/create') }}" class="btn btn-primary">Crear nueva</a>
                    </div>
                </div>
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-hover table-striped table-sm">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center">Nombre de las gestiones</th>
...
<script>
    function confirmarEliminacion(event, id) {
        ...
        Swal.fire({
            title: '¿Se eliminara esta gestion?',
    ...
    $(function () { 
        $("#example1").DataTable({
            dom: 'Bfrtip', // Esto coloca los botones encima de la tabla
            "pageLength": 5,
            "language": { 
